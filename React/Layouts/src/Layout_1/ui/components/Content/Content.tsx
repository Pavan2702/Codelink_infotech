...
const Content: React.FC = () => {
    return (
        <>
            <div id="modal" className="container mx-auto flex flex-col justify-center items-center py-20">
                <div className="max-h-[550px] w-full overflow-y-scroll custom-scrollbar">
                    <div className="px-3 py-12 flex flex-col justify-center items-center">
